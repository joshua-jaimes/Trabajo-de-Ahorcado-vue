...
const niveles = [
  { nombre: "Fácil", detalle: "Palabras de nivel Facil • 8 intentos", icono: "😊" },
  { nombre: "Medio", detalle: "Palabras de nivel Medio • 6 intentos", icono: "😯" },
  { nombre: "Difícil", detalle: "Palabras de nivel Dificil • 5 intentos", icono: "🥵" }
];
</script>
